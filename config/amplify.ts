...
export const amplifyConfig = {
  ...
  aws_project_region: env.FE_PROJECT_REGION,
  aws_cognito_region: env.FE_COGNITO_REGION,
  aws_user_pools_id: env.FE_USER_POOLS_ID,
  aws_user_pools_web_client_id: env.FE_USER_POOLS_WEB_CLIENT_ID,
  aws_appsync_region: env.FE_APPSYNC_REGION,
  aws_appsync_authenticationType: env.FE_APPSYNC_AUTHENTICATION_TYPE,
